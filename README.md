...
> **Status: 0.12.0, packaged and published.** It runs, it is tested, and it installs from
...
make release VERSION=0.12.0 IMAGE_REGISTRY=registry.example.com/platform
```
...
```bash
KUBBY_IMAGE=registry.example.com/platform/kubby:0.12.0
